Logistimo Store Manager App
=======================
[![License: AGPL v3](https://img.shields.io/badge/License-AGPL%20v3-blue.svg)](http://www.gnu.org/licenses/agpl-3.0)

Logistimo Store Manager application is an HTML5, jQuery Mobile based application that allows one to manage inventory, process orders via a mobile application in low-resource environments. The application is network agnostic and can operate using SMS or HTTP APIs of [Logistimo SCM](https://github.com/logistimo/logistimo-web). Please visit [www.logistimo.com](www.logistimo.com) for further details 

Latest Release
------------------

The most recent release is Logistimo Store Manager App [1.6.5](https://github.com/logistimo/html5-app/tree/1.6.5), released on 2017 May 13th.

How to use Logistimo Store Manager App
------------------------------
